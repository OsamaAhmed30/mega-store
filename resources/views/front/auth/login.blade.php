                ...
                <form class="card login-form" action="{{ route('login') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" name="{{config('fortify.username')}}" type="text" id="reg-email" required>
                        </div>
                        <div class="form-group input-group">
                        ...
                        <div class="d-flex flex-wrap justify-content-between bottom-content">
                            <div class="form-check">
                                <input name="remember" type="checkbox" class="form-check-input width-auto" id="exampleCheck1">
