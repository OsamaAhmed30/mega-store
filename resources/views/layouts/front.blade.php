...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset("dist/img/Puzzle-M-Logo-dark.png")}}" />
                        ...
                        <div class="top-left">
                            <ul class="menu-top-link">
                                <li>
                                    <div class="select-position">
                                       <form action="{{route('front.currency.store')}}" method="post" >
                                        @csrf
                                        <select onchange="this.form.submit()"  id="select4" name="currency_code" >
                                ...
                                <li>
                                    <div class="dropdown">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-dark dropdown-toggle btn-dark" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-end">
                            <div class="user">
                                ...
                                {{__('app.hello')}}
                                 {{Auth::guard('admin')->user()->name?? Auth::user()->name ?? 'guest'}}
                            </div>
                            <ul class="user-login text-light">
                               @auth
                               <li>
                                <a href="" onclick="event.preventDefault(); document.getElementById('logout').submit()">{{__('app.signout')}}</a>
                                <form class="mt-2" method="post" id="logout" action="{{route('logout')}}">
                                    @csrf
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        <!-- Start Header Logo -->
                        <div class="logo-direct ">
                           
                            <img class="logo"  src="{{asset("dist/img/Puzzle-M-Logo.png")}}" alt="Logo">
                            <h3>Mega Store</h3>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            <li class="nav-item"><a href="product-grids.html">Mega Store</a></li>
